...
class TransformerConfig(FairseqDataclass):
    ...
    dstore_filename_2: str = field(default=None)
    dstore_filename_3: str = field(default=None)
    use_knn_datastore: bool = field(default=False)
    dstore_fp16: bool = field(default=False)
    dstore_size: int = field(default=1)
    dstore_size_2: int = field(default=1)
    dstore_size_3: int = field(default=1)
    k: int = field(default=8)
    k_2: int = field(default=8)
    k_3: int = field(default=8)
    ...
    knn_lambda_value_2: float = field(default=.5)
    knn_lambda_value_3: float = field(default=.5)
    dstore_2: bool = field(default=False)
    dstore_3: bool = field(default=False)
    ...
    knn_temperature_value_2: float = field(default=10)
    knn_temperature_value_3: float = field(default=10)
