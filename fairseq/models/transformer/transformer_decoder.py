...
class TransformerDecoderBase(FairseqIncrementalDecoder):
    ...
    def __init__(
        ...
        self.dstore_2 = cfg.dstore_2
        self.dstore_3 = cfg.dstore_3
    ...
    def forward(
        ...
        if self.use_knn_datastore:
            if self.use_knn_cache or self.knn_search_every or self.knn_search_random:
                ...
                knn_probs=torch.zeros(x.size(0), 1, self.output_projection.out_features).cuda()
            ...
            knn_lambda, knn_lambda_2, knn_lambda_3 = self.knn_datastore.get_lambda()
            ...
            if (not self.use_knn_cache or last_hidden.size(0) > 0) and self.searching:
                ...
                if self.dstore_2:
                    knn_dists_2 = knn_search_result['distance_2']
                    knn_index_2 = knn_search_result['knn_index_2']
                    tgt_index_2 = knn_search_result['tgt_index_2']
                
                if self.dstore_3:
                    knn_dists_3 = knn_search_result['distance_3']
                    knn_index_3 = knn_search_result['knn_index_3']
                    tgt_index_3 = knn_search_result['tgt_index_3']

                knn_temperature, knn_temperature_2, knn_temperature_3 = self.knn_datastore.get_temperature()

                decode_result = self.knn_datastore.calculate_knn_prob(knn_index, tgt_index, knn_dists, 
                                                                        last_hidden, knn_temperature)

                knn_prob = decode_result['prob']

                if self.dstore_2:
                    decode_result = self.knn_datastore.calculate_knn_prob(knn_index_2, tgt_index_2, knn_dists_2, 
                                                                        last_hidden, knn_temperature_2)

                    knn_prob_2 = decode_result['prob']

                if self.dstore_3:
                    decode_result = self.knn_datastore.calculate_knn_prob(knn_index_3, tgt_index_3, knn_dists_3, 
                                                                        last_hidden, knn_temperature_3)

                    knn_prob_3 = decode_result['prob']
            ...
            if self.dstore_2 and self.dstore_3:
                return x, extra, knn_prob, knn_lambda, knn_dists, knn_index, \
                                 knn_prob_2, knn_lambda_2, knn_dists_2, knn_index_2, \
                                 knn_prob_3, knn_lambda_3, knn_dists_3, knn_index_3 
            elif self.dstore_2:
                return x, extra, knn_prob, knn_lambda, knn_dists, knn_index, \
                                 knn_prob_2, knn_lambda_2, knn_dists_2, knn_index_2, \
                                 None, None, None, None
