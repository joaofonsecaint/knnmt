    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            ...
            decoder_out_tuple = (
                ...
                None if decoder_len <= 6 else decoder_out[6],  # knn prob_2
                None if decoder_len <= 7 else decoder_out[7],  # knn lambda_2
                None if decoder_len <= 8 else decoder_out[8],  # knn distance_2
                None if decoder_len <= 9 else decoder_out[9],  # knn index_2
                None if decoder_len <= 10 else decoder_out[10],  # knn prob_3
                None if decoder_len <= 11 else decoder_out[11],  # knn lambda_3
                None if decoder_len <= 12 else decoder_out[12],  # knn distance_3
                None if decoder_len <= 13 else decoder_out[13],  # knn index_3
            )
