...
def add_preprocess_args(parser):
    ...
    group.add_argument("--testpref", metavar="FP", default=None,
                       help="comma separated, test file prefixes "
                            "(words missing from train set are replaced with <unk>)")
    group.add_argument("--correctionspref", metavar="FP", default=None,
                       help="comma separated, correction files prefixes "
                            "(words missing from train set are replaced with <unk>)")
    group.add_argument("--train_correctionspref", metavar="FP", default=None,
                       help="comma separated, correction files prefixes "
                            "(words missing from train set are replaced with <unk>)")
...
def add_datastore_args(parser):
    ...
    group.add_argument("--k_2", default=64, type=int)
    group.add_argument("--k_3", default=64, type=int)
    ...
    group.add_argument("--dstore_2", action='store_true')
    group.add_argument("--dstore-size-2", metavar="N", default=1, type=int, help="datastore size")
    group.add_argument("--dstore-filename-2", default=None, type=str)
    group.add_argument("--dstore_3", action='store_true')
    group.add_argument("--dstore-size-3", metavar="N", default=1, type=int, help="datastore size")
    group.add_argument("--dstore-filename-3", default=None, type=str)
    ...
    group.add_argument("--num_datastores", metavar="N", default=1, type=int, help="number of datastores to use")
    #group.add_argument("--update_ds", metavar="N", default=0, type=int, help="if we want to update main datastore with corrections")
    group.add_argument("--update_dstore", default=None, type=str, help="save dir for updated datastore")
    group.add_argument("--append_ds", action='store_true')
    group.add_argument("--faiss_index", default=None, type=str)
    return parser
